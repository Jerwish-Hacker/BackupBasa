...
$(function () {
    ...
    const pStepForm = {
        ...
        init: function () {
          ...
          $('body').on('click', 'span.deletetime', function () {
            ...
            $('.deletemodeltext').html("Appointment Type : "+pStepForm.appointment_type+`<br>`+"Location : "+pStepForm.location+`<br>`+"Location : "+pStepForm.location+`<br>`+"Date : "+moment($(this).data('date'), 'YYYY-MM-DD').format("DD MMM YYYY") +`<br>`+"Time : "+$(this).data('time'))
          })

          $('body').on('click', 'span.deletedate', function () {
            pStepForm.id=$(this).data('id')
            pStepForm.type='deletedate'
            $('.deletemodeltext').html("Appointment Type : "+pStepForm.appointment_type+`<br>`+"Location : "+pStepForm.location+`<br>`+"Date : "+moment($(this).data('date'), 'YYYY-MM-DD').format("DD MMM YYYY"))
          })
        ...
        getData(){
          ...
          $.ajax({
            type: "POST",
            url: "/appointment/api/v1/appointmentscheduler-adminlist/",
            data: {
              location: $("#id_locationselector").val(),
              date_start: this.start_date,
              date_end: this.end_date,
              appointment: $("#id_appointmentselector").val(),
        ...
        getLocation(){
          ...
          //   }
          // })
          // let locations =  {{ location | tojson}};
          // console.log(typeof(locations));
          // pStepForm.renderSelectBox("locationselector",locations)
          // pStepForm.renderSelectBox("location",locations)
          // pStepForm.location=$('#id_locationselector').val()
          // pStepForm.init()
        },
    ...
    pStepForm.init()
    pStepForm.getLocation()
    pStepForm.appointment_type =$('#id_appointmentselector').val()
    pStepForm.location =$('#id_locationselector').val()
  ...
  $('#id_appointmentselector').change(function () {
