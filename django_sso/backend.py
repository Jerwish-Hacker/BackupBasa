...
from django_sso import signals
from django_sso.config import provider_config, settings
from django_sso.exceptions import MFARequired
...
class AdfsAuthCodeBackend(AdfsBaseBackend):
    ...
    def authenticate(self, request=None, authorization_code=None, **kwargs):
        ...
        if authorization_code is None or authorization_code == '':
            logger.debug("django_sso authentication backend was called but no authorization code was received")
            return
