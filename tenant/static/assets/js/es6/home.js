        ...
        renderApps:function (){
            ...
            if (this.data.length > 0) {
                ...
                this.data.forEach((element, index) => {
                    ...
                    let button = `<div class="col-1">
                    <a href='apps'><i style="height:22px;width:22px;"  class="fas fa-edit text-primary"></i></a>
                </div>`
                let org_button = `<div class="col-1">
                <a href='settings/'><i style="height:22px;width:22px;" class="fas fa-edit text-primary"></i></a>
            </div>`
                    ...
                    let count_organization =  `<div class="row d-flex justify-content-start p-1">
                    <div class="col-4">
                    </div>
                    <div class="col-4">
                    </div>
                    ...
                    if (element.app_name === "App management") {
                        html += 
                ...
                if (element.app_name === "Organization management") {
                        html += 
                            `<div class="col-12 col-md-3 pt-3 ${element.app_type}" data-name="${element.app_name}">
                                <div class='newsCard news-Slide-up card-box'>
                                    <div class="d-flex justify-content-start d-flex justify-content-start col-12 pr-0">
